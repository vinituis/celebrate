function ConfettiGenerator(params) {
  ...
  var appstate = {
    ...
    max: 250, // Max itens to render
    size: 1.5, // prop size
    animate: true, // Should animate?
    respawn: true, // Should confettis be respawned when getting out of screen?
    props: ['square', 'line'], // Types of confetti
    colors: [[7,9,157],[0,119,182],[80,210,245],[0,180,216]], // Colors to render confetti
    clock: 35, // Speed of confetti fall
